...
if(isset($_GET['stream'])){
  ...
  <h1><img src=\"images/feather.png\" width=\"30\" height=\"45\" alt=\"BirdNET-Pi\">&nbsp;<a href=\"\">BirdNET-Pi</a>&nbsp; &nbsp; <a href=\"\">ort-eller-plats</a>&nbsp;<img src=\"images/flagga.jpg\" width=\"60\" height=\"30\" alt=\"Sweden\">&nbsp;</h1>
  </div>";

/* Remove the comment marks before and after the line of code to display the message in red below the header */
/* 
?> <p align="center" style="color:red; font-size:18px; margin-top: 0; margin-bottom: 5;">Write message here</p> <?php
*/
