...
$startdate = strtotime('last sunday') - (6*86400);
$enddate = strtotime('last sunday') - (0*86400);
...
if(isset($_GET['ascii'])) {
	...
	echo "# BirdNET-Pi: Rapport vecka ".date('W', $enddate)."\n";

	echo "Totala fynd: <b>".$totalcount."</b> (".$percentagedifftotal.")<br>";
	echo "Antal arter: <b>".$totalspeciestally."</b> (".$percentagedifftotaldistinctspecies.")<br><br>";

	echo "= <b>Topp10-arter</b> =<br>";
	...
	echo "<br>= <b>Arter som hörts för första gången</b> =<br>";
	...
	if($newspeciescount == 0) {
		echo "Inga nya arter hördes den här veckan";
	}
	...
	echo '<small>* procentsatserna beräknas i förhållande till vecka '.($prevweek).'.</small>';
...
echo "<h1>Rapport vecka ".date('W', $enddate)." </h1>".date('Y-m-d',$startdate)." - ".date('Y-m-d',$enddate)."<br>";
?></div><?php
...
<table align="center" style="box-shadow:unset"><tr><td style="background-color:#77c487">
	...
	<thead>
		<tr>
			<th><?php echo "Topp 10-arter <br>"; ?></th>
		</tr>
	</thead>
	<tbody>
	<?php
	...
	<thead>
		<tr>
			<th><?php echo "Arter som hörts för första gången <br>"; ?></th>
		</tr>
	</thead>
	<tbody>
	<?php 
	...
	if($newspeciescount == 0) {
		echo "<tr><td>Inga nya arter hördes den här veckan</td></tr>";
	}
	?>
	</tbody>
	</table>
...
<div style="text-align:center">
	<hr><small style="font-size:small">* procentsatserna beräknas i förhållande till vecka <?php echo date('W', $enddate) - 1; ?></small>
</div>