...
sed -i 's#<a href="https://wikipedia.org/wiki/<?php echo $sciname; ?>"#<a href="https://sv.wikipedia.org/wiki/<?php echo $comname;?>"#g' overview.phpsed -i 's/Species Today/Arter i dag/g' overview.php
...
sed -i 's#<a href="https://wikipedia.org/wiki/<?php echo $sciname;?>"#<a href="https://sv.wikipedia.org/wiki/<?php echo $comname;?>"#g' todays_detections.php   
...
sed -i 's/Sort by confidence/Sortera efter tillförlitlighet/g' play.php
sed -i 's#wikipedia\.org/wiki/\$sciname#sv\.wikipedia\.org/wiki/\$sciname#g' play.php   
